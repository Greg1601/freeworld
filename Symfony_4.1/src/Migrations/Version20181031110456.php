 ...
 */
final class Version20181031110456 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_users ADD random_key VARCHAR(255) NOT NULL, CHANGE role_id role_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE app_users DROP random_key, CHANGE role_id role_id INT DEFAULT NULL');
