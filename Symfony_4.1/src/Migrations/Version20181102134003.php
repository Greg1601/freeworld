 ...
 */
final class Version20181102134003 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD vote TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE messages CHANGE is_treated is_treated TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE messages CHANGE is_treated is_treated TINYINT(1) DEFAULT \'0\' NOT NULL');
        $this->addSql('ALTER TABLE post DROP vote');
    }
}
