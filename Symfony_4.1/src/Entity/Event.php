...
class Event
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Type", inversedBy="events")
     */
    private $types;
    ...
    public function getCoordonates(): ?string
    {
        return $this->coordonates;
    }

    public function setCoordonates(string $coordonates): self
    {
